...
kbBS=: kbBS_jgl2_
kbLF=: kbLF_jgl2_
kbENTER=: kbENTER_jgl2_
kbRETURN=: kbRETURN_jgl2_
kbPUP=: kbPUP_jgl2_
kbPDOWN=: kbPDOWN_jgl2_
kbEND=: kbEND_jgl2_
kbHOME=: kbHOME_jgl2_
kbLEFT=: kbLEFT_jgl2_
kbUP=: kbUP_jgl2_
kbRIGHT=: kbRIGHT_jgl2_
kbDOWN=: kbDOWN_jgl2_
kbESC=: kbESC_jgl2_
kbINS=: kbINS_jgl2_
kbDEL=: kbDEL_jgl2_
isNonAlfaNum=: 3 : 0
(y < 32) +. (16bf800<:y) *. (16bf8ff>:y)
)
alfndx=: 3 & u:
assign=: 4 : '".x,''=:y'''
boxitem=: ,`(<"_1) @. (0=L.)
...
'Scw Sch'=: 2 {. (2&}. @ ". @ (wd & 'qscreen')) :: (800 600"_) ''
Roff=: 0
Hier=: 0
Sparse=: 0
Sparse0=: <''
...
EVENTS=: ;: j,' char copy focus focuslost paint resize paste print undo'
initevents=: 3 : 0
if. 0=GRIDHWNDC do.
...
glpen (1,PS_SOLID) [ glbrush'' [ glrgb 1 { ButtonColor
glrect BSSxywh
...
glpen (1,PS_SOLID) [ glrgb 2 { ButtonColor
...
glbrush'' [ glrgb 1 { ButtonColor
glpen (1,PS_SOLID) [ glrgb 5 { ButtonColor
glrect x,.y,.h,.h
...
glbrush'' [ glrgb 0 { HdrColor
glpen (1,PS_SOLID) [ glrgb 3 { GridColor
glrect AXrect

'px py pw ph'=. |: AXrect
glpen (1,PS_SOLID) [ glrgb 2 { GridColor
...
if. LvlRow do.
  ...
  if. LvlDivider do. glpen (1,PS_SOLID) [ glrgb 4 { GridColor
...
glpen (1,PS_SOLID) [ glrgb 4 { GridColor
...
glpen (1,PS_SOLID) [ glrgb ((0<LCWalkn){4 3) { GridColor
...
glpen (1,PS_SOLID) [ glrgb ((0<LRWalkn){4 3) { GridColor
gllines (x+2),(LCMy+1),(x+2),LCMy+LvlHit
glbrush'' [ glrgb 0 { ButtonColor
glpen (1,PS_SOLID)
glpolygon (6$"1 xy) +"1/ 0 0,w,w,+:w,0
...
select. HDRSTYLE
case. 1 do.
  glpen (1,PS_SOLID) [ glrgb 1 { GridColor
...
xw=. x+w-t
glbrush'' [ glrgb 1 { ButtonColor
glpen (1,PS_SOLID) [ glrgb 0 { GridColor
glrect x,y,w,t
glpen (1,PS_SOLID) [ glrgb 3 { ButtonColor
...
kbEXIT1=: kbRETURN,kbENTER,kbEND,kbHOME,kbLEFT,kbRIGHT,kbUP,kbDOWN
editchar=: editcharx=: 3 : 0

c=. ucp sysdata__locV
d=. alfndx {. c
m=. 0 ". sysmodifiers__locV
if. (d > 31) > isNonAlfaNum d do.
...
GRIDPJN=: 0 : 0
pc gridp;pn "Grid";
xywh 0 0 800 600;cc grid isigraph;
pas 0 0;pcenter;
rem form end;
)

GRIDP=: (GRIDP;GRIDPJN){::~ ('jwin32';'jjava') e.~ < (11!:0) ::0: 'qwd'
gridpdestroy=: 3 : 0
destroy__grid''
wd ::0: 'pclose'
codestroy''
...
finalize_jzgrid_^:(3=(4!:0)@<) 'finalize_jzgrid_'
