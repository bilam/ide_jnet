...
NB. D3=: file2url jpath '~addons/ide/jnet/js/d3.v3.min.js'
D3=: 'http://d3js.org/d3.v3.min.js'
F0=: file2url jpath '~addons/ide/jnet/demo/data.tsv'

NB. =========================================================
svgview=: 3 : 0
's t'=. y
wd 'pc8j svgview;minwh 500 500;cc w webview'
h=. '<!DOCTYPE html><html><head><meta charset="utf-8"/>',LF
h=. h,'<meta http-equiv="X-UA-Compatible" content="IE=edge" />',LF
